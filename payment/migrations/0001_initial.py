...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MPower_Payment'
        db.create_table(u'payment_mpower_payment', (
        ...
        db.send_create_signal(u'payment', ['MPower_Payment'])


    def backwards(self, orm):
        # Deleting model 'MPower_Payment'
        db.delete_table(u'payment_mpower_payment')


    models = {
        u'payment.mpower_payment': {
            'Meta': {'object_name': 'MPower_Payment'},
