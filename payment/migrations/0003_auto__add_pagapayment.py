...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PagaPayment'
        db.create_table(u'payment_pagapayment', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('transaction', self.gf('django.db.models.fields.related.OneToOneField')(related_name='paga_payment', unique=True, to=orm['transaction.Transaction'])),
            ('paga_transaction_reference', self.gf('django.db.models.fields.CharField')(max_length=30, blank=True)),
            ('paga_transaction_id', self.gf('django.db.models.fields.CharField')(max_length=30, blank=True)),
            ('processed_at', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'payment', ['PagaPayment'])


    def backwards(self, orm):
        # Deleting model 'PagaPayment'
        db.delete_table(u'payment_pagapayment')
