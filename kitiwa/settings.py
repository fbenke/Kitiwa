...
MPOWER_ENDPOINT_CHECK_INVOICE_STATUS = os.environ.get('MPOWER_ENDPOINT_CHECK_INVOICE_STATUS')
...
MPOWER_RESPONSE_INPUT_ERROR = '1001'
MPOWER_RESPONSE_ACCOUNT_ERROR = '3001'
MPOWER_STATUS_COMPLETED = 'completed'
