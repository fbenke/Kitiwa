...
class TransactionAdmin(admin.ModelAdmin):
    ...
    fields = (
        ...
        'processed_exchange_rate', 'transaction_uid', 'mpower_response_code',
    ...
    readonly_fields = (
        ...
        'transaction_uid', 'mpower_response_code', 'mpower_response_text',
        'mpower_confirm_token', 'mpower_receipt_url',
    )
    list_display = ('btc_wallet_address', 'notification_phone_number', 'state',)
