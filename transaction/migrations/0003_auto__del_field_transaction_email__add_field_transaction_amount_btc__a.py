...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'transaction_transaction', 'email')

        # Adding field 'Transaction.amount_btc'
        db.add_column(u'transaction_transaction', 'amount_btc',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Transaction.processed_exchange_rate'
        db.add_column(u'transaction_transaction', 'processed_exchange_rate',
        ...
        db.alter_column(u'transaction_pricing', 'start', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):
        # Adding field 'Transaction.email'
        db.add_column(u'transaction_transaction', 'email',
                      self.gf('django.db.models.fields.EmailField')(default='', max_length=30, blank=True),
                      keep_default=False)

        # Deleting field 'Transaction.amount_btc'
        db.delete_column(u'transaction_transaction', 'amount_btc')

        # Deleting field 'Transaction.processed_exchange_rate'
        db.delete_column(u'transaction_transaction', 'processed_exchange_rate')
        ...
        # Changing field 'Pricing.start'
        db.alter_column(u'transaction_pricing', 'start', self.gf('django.db.models.fields.DateTimeField')())
