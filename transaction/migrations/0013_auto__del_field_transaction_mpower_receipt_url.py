...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Transaction.mpower_receipt_url'
        db.delete_column(u'transaction_transaction', 'mpower_receipt_url')


    def backwards(self, orm):
        # Adding field 'Transaction.mpower_receipt_url'
        db.add_column(u'transaction_transaction', 'mpower_receipt_url',
