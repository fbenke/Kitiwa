...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for pricing in orm.Pricing.objects.all():
            pricing.markup_cat_1 = pricing.markup
            pricing.markup_cat_2 = pricing.markup
            pricing.markup_cat_3 = pricing.markup
            pricing.markup_cat_4 = pricing.markup
            pricing.save()

    def backwards(self, orm):
        "Manually written backwards method."
        for pricing in orm.Pricing.objects.all():
            pricing.markup = pricing.markup_cat_1
