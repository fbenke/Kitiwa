...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Transaction.smsgh_response_status'
        db.add_column(u'transaction_transaction', 'smsgh_response_status',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=5, blank=True),
                      keep_default=False)

        # Adding field 'Transaction.smsgh_message_id'
        db.add_column(u'transaction_transaction', 'smsgh_message_id',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=30, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Transaction.smsgh_response_status'
        db.delete_column(u'transaction_transaction', 'smsgh_response_status')

        # Deleting field 'Transaction.smsgh_message_id'
        db.delete_column(u'transaction_transaction', 'smsgh_message_id')
    ...
    models = {
        ...
        u'transaction.transaction': {
            ...
            'smsgh_message_id': ('django.db.models.fields.CharField', [], {'max_length': '30', 'blank': 'True'}),
