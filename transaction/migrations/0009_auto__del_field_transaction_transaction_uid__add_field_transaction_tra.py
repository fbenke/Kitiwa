...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Transaction.transaction_uuid'
        db.add_column(u'transaction_transaction', 'transaction_uuid',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Transaction.transaction_uuid'
        db.delete_column(u'transaction_transaction', 'transaction_uuid')
