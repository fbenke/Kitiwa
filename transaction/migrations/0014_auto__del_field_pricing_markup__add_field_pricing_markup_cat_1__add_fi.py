...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Pricing.markup_cat_1'
        db.add_column(u'transaction_pricing', 'markup_cat_1',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'Pricing.markup_cat_2'
        db.add_column(u'transaction_pricing', 'markup_cat_2',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'Pricing.markup_cat_3'
        db.add_column(u'transaction_pricing', 'markup_cat_3',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'Pricing.markup_cat_4'
        db.add_column(u'transaction_pricing', 'markup_cat_4',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Pricing.markup_cat_1'
        db.delete_column(u'transaction_pricing', 'markup_cat_1')

        # Deleting field 'Pricing.markup_cat_2'
        db.delete_column(u'transaction_pricing', 'markup_cat_2')

        # Deleting field 'Pricing.markup_cat_3'
        db.delete_column(u'transaction_pricing', 'markup_cat_3')

        # Deleting field 'Pricing.markup_cat_4'
        db.delete_column(u'transaction_pricing', 'markup_cat_4')
