...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Transaction.smsgh_message_id'
        db.alter_column(u'transaction_transaction', 'smsgh_message_id', self.gf('django.db.models.fields.CharField')(max_length=50))

    def backwards(self, orm):

        # Changing field 'Transaction.smsgh_message_id'
        db.alter_column(u'transaction_transaction', 'smsgh_message_id', self.gf('django.db.models.fields.CharField')(max_length=30))
