...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Pricing.markup_cat_1_upper'
        db.add_column(u'transaction_pricing', 'markup_cat_1_upper',
                      self.gf('django.db.models.fields.IntegerField')(default=5),
                      keep_default=False)

        # Adding field 'Pricing.markup_cat_2_upper'
        db.add_column(u'transaction_pricing', 'markup_cat_2_upper',
                      self.gf('django.db.models.fields.IntegerField')(default=100),
                      keep_default=False)

        # Adding field 'Pricing.markup_cat_3_upper'
        db.add_column(u'transaction_pricing', 'markup_cat_3_upper',
                      self.gf('django.db.models.fields.IntegerField')(default=500),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Pricing.markup_cat_1_upper'
        db.delete_column(u'transaction_pricing', 'markup_cat_1_upper')

        # Deleting field 'Pricing.markup_cat_2_upper'
        db.delete_column(u'transaction_pricing', 'markup_cat_2_upper')

        # Deleting field 'Pricing.markup_cat_3_upper'
        db.delete_column(u'transaction_pricing', 'markup_cat_3_upper')
